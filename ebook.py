...
class Ebook(object):
  ...
  def assemble(self):
    ...
    with open('assets/snaily.png', 'rb') as fh:
      snaily = fh.read()
    book.set_cover('snaily.png', snaily)
...
<html>
  ...
  <body>
    ...
    <hr/>
    <center>
      Generated by <a href="http://github.com/kchodorow/blook">Blook</a>: a tool for turning blogs into ebooks.
      <img src="snaily.png"/>
    </center>
  </body>
</html>
""".format(title=self._title, url=self._url)
    return cover
